...
import net.mcreator.projectnewworld.procedures.TntPalletProjectileHitsBlockProcedure;
import net.mcreator.projectnewworld.entity.renderer.TntPalletRenderer;
...
public class TntPalletItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:tnt_pallet")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_tnt_pallet").setRegistryName("projectile_tnt_pallet");

	public TntPalletItem(ProjectnewworldModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TntPalletRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			TntPalletProjectileHitsBlockProcedure.executeProcedure(Stream
