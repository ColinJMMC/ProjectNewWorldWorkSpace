...
import net.mcreator.projectnewworld.procedures.LightrayProjectileHitsPlayerProcedure;
import net.mcreator.projectnewworld.entity.renderer.LightrayRenderer;
...
public class LightrayItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:lightray")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_lightray").setRegistryName("projectile_lightray");

	public LightrayItem(ProjectnewworldModElements instance) {
		super(instance, 44);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LightrayRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			LightrayProjectileHitsPlayerProcedure.executeProcedure(Stream
