...
import net.mcreator.projectnewworld.procedures.GiantslashProjectileHitsBlockProcedure;
import net.mcreator.projectnewworld.entity.renderer.GiantslashRenderer;
...
public class GiantslashItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:giantslash")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_giantslash").setRegistryName("projectile_giantslash");

	public GiantslashItem(ProjectnewworldModElements instance) {
		super(instance, 51);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GiantslashRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			GiantslashProjectileHitsBlockProcedure.executeProcedure(Stream
