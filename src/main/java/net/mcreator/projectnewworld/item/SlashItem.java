...
import net.mcreator.projectnewworld.entity.renderer.SlashRenderer;
import net.mcreator.projectnewworld.ProjectnewworldModElements;

import java.util.Random;

@ProjectnewworldModElements.ModElement.Tag
public class SlashItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:slash")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_slash").setRegistryName("projectile_slash");

	public SlashItem(ProjectnewworldModElements instance) {
		super(instance, 24);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SlashRenderer.ModelRegisterHandler());
	}
