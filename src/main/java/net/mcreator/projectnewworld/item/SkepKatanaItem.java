...
public class SkepKatanaItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:skep_katana")
	public static final Item block = null;

	public SkepKatanaItem(ProjectnewworldModElements instance) {
		super(instance, 30);
	}
