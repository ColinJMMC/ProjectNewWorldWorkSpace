...
import net.mcreator.projectnewworld.entity.renderer.Gryphonbarrage1Renderer;
import net.mcreator.projectnewworld.ProjectnewworldModElements;

import java.util.Random;

@ProjectnewworldModElements.ModElement.Tag
public class Gryphonbarrage1Item extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:gryphonbarrage_1")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_gryphonbarrage_1").setRegistryName("projectile_gryphonbarrage_1");

	public Gryphonbarrage1Item(ProjectnewworldModElements instance) {
		super(instance, 48);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Gryphonbarrage1Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("gryphonbarrage_1");
		}
