...
import net.mcreator.projectnewworld.procedures.TpLightRayProjectileHitsBlockProcedure;
import net.mcreator.projectnewworld.entity.renderer.TpLightRayRenderer;
...
public class TpLightRayItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:tp_light_ray")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_tp_light_ray").setRegistryName("projectile_tp_light_ray");

	public TpLightRayItem(ProjectnewworldModElements instance) {
		super(instance, 46);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TpLightRayRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			TpLightRayProjectileHitsBlockProcedure.executeProcedure(Stream
