...
import net.mcreator.projectnewworld.entity.renderer.BeeSlashRenderer;
import net.mcreator.projectnewworld.ProjectnewworldModElements;

import java.util.Random;

@ProjectnewworldModElements.ModElement.Tag
public class BeeSlashItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:bee_slash")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_bee_slash").setRegistryName("projectile_bee_slash");

	public BeeSlashItem(ProjectnewworldModElements instance) {
		super(instance, 28);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BeeSlashRenderer.ModelRegisterHandler());
	}
