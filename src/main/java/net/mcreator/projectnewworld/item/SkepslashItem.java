...
import net.mcreator.projectnewworld.entity.renderer.SkepslashRenderer;
import net.mcreator.projectnewworld.ProjectnewworldModElements;

import java.util.Random;

@ProjectnewworldModElements.ModElement.Tag
public class SkepslashItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:skepslash")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_skepslash").setRegistryName("projectile_skepslash");

	public SkepslashItem(ProjectnewworldModElements instance) {
		super(instance, 27);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SkepslashRenderer.ModelRegisterHandler());
	}
