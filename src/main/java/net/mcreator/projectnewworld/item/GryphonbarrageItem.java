...
import net.mcreator.projectnewworld.entity.renderer.GryphonbarrageRenderer;
import net.mcreator.projectnewworld.ProjectnewworldModElements;

import java.util.Random;

@ProjectnewworldModElements.ModElement.Tag
public class GryphonbarrageItem extends ProjectnewworldModElements.ModElement {
	@ObjectHolder("projectnewworld:gryphonbarrage")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_gryphonbarrage").setRegistryName("projectile_gryphonbarrage");

	public GryphonbarrageItem(ProjectnewworldModElements instance) {
		super(instance, 47);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GryphonbarrageRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("gryphonbarrage");
		}
