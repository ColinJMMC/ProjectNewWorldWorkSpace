...
@OnlyIn(Dist.CLIENT)
public class BeeSlashRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BeeSlashItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<BeeSlashItem.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("projectnewworld:textures/entities/slashbee.png");
		...
		@Override
		public void render(BeeSlashItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(BeeSlashItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
